...
public class AdminPanelPage extends BaseSmartGaragePage {
    ...
    @FindBy(xpath = "//a[@href='/users']") private WebElement allUsersTab;

    @FindBy(xpath = "//a[@href='/client-cars']") private WebElement clientCars;

    @FindBy(xpath = "//a[@href='/orders']") private WebElement orders;

    @FindBy(xpath = "//a[@href='/users/employee']") private WebElement createEmployee;

    @FindBy(xpath = "//a[@href='/users/mechanic']") private WebElement createMechanic;

    @FindBy(xpath = "//a[@href='/users/customer']") private WebElement createCustomer;
