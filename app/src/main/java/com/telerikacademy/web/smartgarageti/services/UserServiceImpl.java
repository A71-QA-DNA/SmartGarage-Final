...
//        this.emailService = emailService;
    ...
    @Override
    public UserDto resetPassword(ForgottenPasswordDto forgottenPasswordDto) {
...
//        sendForgottenPasswordEmail(user.getEmail(), newPassword);
    ...
    private UserDto userRegistration(UserCreationDto userCreationDto) {
        ...
        validateUniqueUserFields(userCreationDto);
        ...
        userRepository.save(user);
//        sendUserCredentialsEmail( user,  role);
    ...
    private UserDto mechanicRegistration(UserCreationDto userCreationDto) {
        ...
        //        sendUserCredentialsEmail( mechanic,  role);
...
//        sendUserCredentialsEmail( employee,  role);

        return MapperHelper.toUserDto(employee);
    }

    private void validateUniqueUserFields(UserCreationDto userCreationDto) {
...
//    public void sendUserCredentialsEmail(User user, String role) {
//        String subject;
//        String message;
//
//        switch (role.toLowerCase()) {
//            case "employee":
//                subject = "Welcome to Smart Garage";
//                message = "As a new member of our team, your role here will be to manage the garage. <br>"
//                        + "Your username is: " + user.getUsername() + "<br>"
//                        + "Your password is: " + user.getPassword();
//                break;
//            case "mechanic":
//                subject = "Welcome to Smart Garage";
//                message = "As a new member of our team, your role here will be to repair cars. <br>"
//                        + "Your username is: " + user.getUsername() + "<br>"
//                        + "Your password is: " + user.getPassword();
//                break;
//            case "user":
//                subject = "Welcome to Smart Garage";
//                message = "Your username is: " + user.getUsername() + "<br>"
//                        + "Your password is: " + user.getPassword();
//                break;
//            default:
...
//        String subject = "Your new password for Smart Garage TI App";
