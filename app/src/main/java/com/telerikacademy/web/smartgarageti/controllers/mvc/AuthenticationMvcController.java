...
public class AuthenticationMvcController {
    ...
    public String showRegister(Model model) {
        ...
        model.addAttribute("showRegisterForm", true); // да се показва регистрационната форма
        return "LoginView";
    }
...
//            return "LoginView";
            model.addAttribute("login", new LoginDto());
            model.addAttribute("showLogin", false);
            model.addAttribute("showRegisterForm", true); // показваме регистрацията с грешки
            return "LoginView";
        }
        try {
            ...
            model.addAttribute("newUsername", userDto.getUsername());
            model.addAttribute("newPassword", userDto.getPassword());
            model.addAttribute("successMessage", "Registration successful!");
            model.addAttribute("source", "register");
            ...
            if (errorMessage.contains("username")) {
                ...
                bindingResult.rejectValue("email", "registration_error", e.getMessage());
            } else if (errorMessage.contains("phone")) {
                bindingResult.rejectValue("phoneNumber", "registration_error", e.getMessage());
            } else {
