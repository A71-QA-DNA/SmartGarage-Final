...
//@Service
//public class CurrencyConversionServiceImpl implements CurrencyConversionService {
//    private static final double BGN_TO_EUR_RATE = 0.51129; // 1 BGN = 0.51129 EUR
//    private static final double EUR_TO_BGN_RATE = 1.95583; // 1 EUR = 1.95583 BGN
//
//    @Override
//    public double convertCurrency(double amount, String fromCurrency, String toCurrency) {
//        if ("BGN".equalsIgnoreCase(fromCurrency) && "EUR".equalsIgnoreCase(toCurrency)) {
//            return amount * BGN_TO_EUR_RATE;
//        } else if ("EUR".equalsIgnoreCase(fromCurrency) && "BGN".equalsIgnoreCase(toCurrency)) {
...
public class CurrencyConversionServiceImpl implements CurrencyConversionService {
    ...
    static {
        exchangeRates.put("BGN_TO_EUR", 0.51129);
        exchangeRates.put("EUR_TO_BGN", 1.95583);
        exchangeRates.put("BGN_TO_USD", 0.55);
        exchangeRates.put("USD_TO_BGN", 1.81818);
    }
