...
public class CurrencyConversionServiceImplTests {
    ...
    @Test
    void convertCurrency_ShouldReturnConvertedAmount_WhenValidCurrenciesProvided() {
        double amount = 100.0;
        String fromCurrency = "BGN";
        String toCurrency = "EUR";
        ...
        assertEquals(51.129, result, 0.001);
    }

    @Test
    void convertCurrency_ShouldReturnSameAmount_WhenFromAndToCurrenciesAreSame() {
        double amount = 100.0;
        String fromCurrency = "BGN";
        String toCurrency = "BGN";
    ...
    @Test
    void convertCurrency_ShouldThrowException_WhenUnsupportedCurrencyConversion() {
        double amount = 100.0;
        String fromCurrency = "BGN";
    ...
    @Test
    void convertCurrency_ShouldReturnConvertedAmount_WhenFromUSDToBGN() {
        double amount = 100.0;
        ...
        assertEquals(181.818, result, 0.001);
    }

    @Test
    void convertCurrency_ShouldReturnConvertedAmount_WhenFromBGNToUSD() {
        double amount = 100.0;
        String fromCurrency = "BGN";
        String toCurrency = "USD";
